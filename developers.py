...
def dev():
    ...
    with col1:
        ...
        <div class="transparent-box">
            <h5>Abdullah Hussain Shaikh</h5>
            <p>Mufakkam Jah College Of Engineering</p>
            <a href="https://github.com/Error-2515">Github</a>
        </div>
        """, unsafe_allow_html=True)
        st.text("")
        st.markdown("""
        <div class="transparent-box">
            <h5>Nabeel Shareef</h5>
            <p>Nawab Shah Alam Khan College Of Engineering </p>
            <a href="https://github.com/Nabeeeel02">Github</a>
        </div>
        """, unsafe_allow_html=True)
    ...
    with col2:
        st.markdown("""
        <div class="transparent-box">
            <h5>Ans Ahmed Khan</h5>
            <p>Nawab Shah Alam Khan College Of Engineering </p>
            <a href="https://github.com/Uchiha-byte/Uchiha-byte">Github</a>
        </div>
        """, unsafe_allow_html=True)
        st.text("")
        st.markdown("""
